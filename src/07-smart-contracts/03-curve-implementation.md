...
[Curve smart contract](https://www.curve.fi/stableswap-paper.pdf) 已部分移植自其原始版本
...
完整的 Zinc 源代码在 [这里](https://github.com/matter-labs/curve-zinc).

## 代码清单

以下是 Curve 实现中最重要的部分。省略了一些带有类型和常量的样板代码，可以通过上面的链接查看。
